...
const htmlTaskContent = ({ id, title, description, type, url }) => `
  <div class="col-md-6 col-lg-4 mt-3" id="${id}">
    <div class='card shadow-sm task__card'>
      ...
      <div class='card-body'>
          ${url ? `<img width='100%' src="${url}" alt='Card Image' class='card-img-top md-3 rounded-lg' />` : `<img width='100%' src="https://example.com/placeholder.jpg" alt='Card Image' class='card-img-top md-3 rounded-lg' />`}
